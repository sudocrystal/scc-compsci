...
## Programs for class
[Ch6a](https://github.com/sudocrystal/CS141-InteractiveLectures/blob/main/Ch6a/Ch6aFileProcessing)
...
public class Ch6aFileProcessing {
   ...
   public static void gradeReport(Scanner in, PrintStream out) throws FileNotFoundException {
      while(in.hasNext()) {
         String name = in.next();
         ...
         out.print(name + " = ");
         out.printf("%.2f average", average);
         out.println(" for " + num + " grades");
      }
   }
 }
```
