# Advising Notes as you finish CS 110

+ The required CS sequence for most students is CS 110 (previously 121) -> CS 141 -> CS 143
+ Putting a gap between CS 110 and CS 141 is totally fine (even a year gap is fine!)
...
## Reviewing CS 0 (CS 110) material
...
CS 141 is taught in Java. As Shoreline's CS 110 is taught in Python, here you will find a couple resources that should help you with the transition from Python to Java.
